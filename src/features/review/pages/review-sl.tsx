              ...
              <div className="space-y-6">
                {!canSubmit && (
                  <div className="rounded-xl border border-warning-100 bg-warning-50 px-4 py-3 text-sm text-warning-700 dark:border-warning-500/20 dark:bg-warning-500/10 dark:text-warning-300">
                    ...
                    <strong>{appraisal.status.replace(/_/g, ' ')}</strong>; SL
                    scoring is locked.
                  </div>
                )}
                ...
                <div>
                  <div className="mb-3 flex items-center justify-between">
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400">
                      {active.sl_score
                        ? SCORE_LABELS[active.sl_score]
                        : 'Choose a score'}
                    </p>
                  </div>
                  <ScorePicker
                    value={active.sl_score ?? 0}
                    disabled={!canSubmit}
